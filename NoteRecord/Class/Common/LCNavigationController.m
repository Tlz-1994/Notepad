...
static const CGFloat LCAnimationDuration = 0.45f;   // Push / Pop 动画持续时间
static const CGFloat LCMaxBlackMaskAlpha = 0.60f;   // 黑色背景透明度
static const CGFloat LCZoomRatio         = 0.80f;   // 后面视图缩放比
